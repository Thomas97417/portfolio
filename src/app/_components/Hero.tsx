      ...
      <Section className="flex items-start gap-4 max-lg:flex-col">
        <div className="flex flex-[3] flex-col gap-2">
          ...
          <p className="text-base leading-8">
            ...
            developer. I love creating <Code>apps</Code> and{" "}
            <Code>websites</Code> that inspires and helps people. I am a{" "}
            <Code>French</Code> young software developer, eager to learn new
            tech and <Code>develop</Code> my skills. My main techs are{" "}
            <Code>React</Code>, <Code>NextJS</Code> and <Code>TypeScript</Code>
            <br />
            Check my <Code>Github</Code> page to see my projects and
            contributions
          </p>
        </div>
